...
(async () => {
  ...
  let npc = token.actor.system.props;
  let header = `<h1>${token.actor.name}</h1>`
  let content = `<div style="height:600px;overflow-y:scroll">`;
      ...
      buttons: {
          ...
          createJournalEntry: {
            ...
            callback: async () => {
                ...
                const newEntry = await JournalEntryPage.create(entryData, {
                  parent: journal,
